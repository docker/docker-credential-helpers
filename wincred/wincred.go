...
func (h Wincred) Add(creds *credentials.Credentials) error {
	...
	g.Attributes = append(g.Attributes,
		winc.CredentialAttribute{Keyword: "label", Value: []byte(credentials.CredsLabel)},
		winc.CredentialAttribute{Keyword: "encoding", Value: []byte("utf16le")},
	)
